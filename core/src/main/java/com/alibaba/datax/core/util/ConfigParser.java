...
public final class ConfigParser {
    ...
    public static Configuration parse(final String jobPath) {
        ...
        try {
            ...
            throw DataXException.asDataXException(FrameworkErrorCode.PLUGIN_INSTALL_ERROR, String.format("插件[%s,%s]加载，Exception:%s",readerPluginName, writerPluginName, e.getMessage()));
        }
