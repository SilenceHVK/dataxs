...
public class CoreConstant {
	...
	public static final String DATAX_JOB_CONTENT_READER_PARAMETER_CONNECTION = "job.content[0].reader.parameter.connection";
	public static final String DATAX_JOB_CONTENT_WRITER_PARAMETER_CONNECTION = "job.content[0].writer.parameter.connection";
